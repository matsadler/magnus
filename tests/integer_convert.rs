...
fn it_converts_integers() {
    ...
    let res = unsafe { i8::implicit_convert_from(val) };
    ...
    let res = unsafe { i16::implicit_convert_from(val) };
    ...
    let res = unsafe { i32::implicit_convert_from(val) };
    ...
    let res = unsafe { i64::implicit_convert_from(val) };
    ...
    // in range
    let val = magnus::eval_static("-2147483648").ok().unwrap();
    let res = unsafe { isize::implicit_convert_from(val) };
    assert_eq!(res.ok().unwrap(), -2147483648);
    ...
    let res = unsafe { u8::implicit_convert_from(val) };
    ...
    let res = unsafe { u16::implicit_convert_from(val) };
    ...
    let res = unsafe { u32::implicit_convert_from(val) };
    ...
    let res = unsafe { u64::implicit_convert_from(val) };
    ...
    // in range
    let val = magnus::eval_static("4294967295").ok().unwrap();
    let res = unsafe { usize::implicit_convert_from(val) };
    assert_eq!(res.ok().unwrap(), 4294967295);
