...
impl RObject {
    ...
    pub unsafe fn from_value(val: &Value) -> Option<Self> {
        ...
        (r_basic.builtin_type() == ruby_value_type::RUBY_T_OBJECT).then(|| Self(val.into_inner()))
    }

    // TODO: use or remove
    #[allow(dead_code)]
    pub(crate) fn as_internal(&self) -> NonNull<ruby_sys::RObject> {
