...
/// locations.
///
/// The programmer is responsible for  maintaining invariants.
#[derive(Copy, Clone)]
#[repr(transparent)]
...
impl RFiber {
    ...
    pub unsafe fn yield_now<A, R>(args: A) -> Result<R, Error>
    where
        A: ArgList,
        R: TryConvert,
    {
    ...
    pub unsafe fn resume<A, R>(&self, args: A) -> Result<R, Error>
    where
        A: ArgList,
        R: TryConvert,
    {
    ...
    pub unsafe fn transfer<A, R>(&self, args: A) -> Result<R, Error>
    where
        A: ArgList,
        R: TryConvert,
    {
    ...
    pub unsafe fn raise<R>(&self) -> Result<R, Error>
    where
        R: TryConvert,
    {
        protect(|| {
    ...
    pub unsafe fn raise_with_message<M, R>(&self, msg: M) -> Result<R, Error>
    where
        M: Into<RString>,
        R: TryConvert,
    {
    ...
    pub unsafe fn raise_exn_with_message<C, M, R>(&self, cls: C, msg: M) -> Result<R, Error>
    where
    ...
    /// `Fiber.raise(...)`
    pub unsafe fn raise_args<A, R>(&self, args: A) -> Result<R, Error>
    where
        A: ArgList,
        R: TryConvert,
    {
